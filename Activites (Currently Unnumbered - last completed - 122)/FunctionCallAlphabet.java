...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		i( 300 );    // pass it any integer and it will display a word beginning with I 
		System.out.print( j( 300 ) );    // returns a different word depending on what you pass it (1-3)
		...
		w( 300 );    // pass it any integer and it will display a word beginning with W 
		System.out.print( x( 300 ));    // returns a different word depending on what you pass it (1-2)
